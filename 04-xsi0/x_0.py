...
def verificare_castigator(tabla):
    if tabla[1] == tabla[2] == tabla[3] is not None or tabla[4] == tabla[5] == tabla[6] is not None or tabla[7] == \
            tabla[8] == tabla[9] is not None or \
            tabla[1] == tabla[4] == tabla[7] is not None or tabla[8] == tabla[5] == tabla[2] is not None or tabla[9] == \
            tabla[6] == tabla[3] is not None or \
