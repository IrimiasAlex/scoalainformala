...
#variabile-
#my_var, my_var_1 = 0, 1     --> atribuire mai multe veriabile
...
#nume = "Irimias"
#prenume = "Alexandru"
#prezentare = " Numele meu este {1} si prenumele este {0}".format(nume, prenume)    --->Inverseaza "Numele meu este Alexandru si prenumele Irimias
#print(prezentare)

#prezentare = f"Numele meu este{nume} si prenumele meu este{prenume}" --> ca sa nu mai folosesc .format
